...
export const METADATA = {
  home: {
    title: 'Selwyn Jesudas — Full-Stack Developer & AI Student',
  ...
  insighted: {
    ...
    ogImage: `${BASE_URL}/og-image-insighted.jpg`,
  ...
  rapid100: {
    title: 'RAPID-100 — AI Emergency Call Triage | Selwyn Jesudas',
    ...
    ogImage: `${BASE_URL}/og-image-rapid100.jpg`,
  ...
  metromind: {
    title: 'MetroMind — Smart City Traffic Simulation | Selwyn Jesudas',
    ...
    ogImage: `${BASE_URL}/og-image-metromind.jpg`,
  ...
  notfound: {
    title: '404 — Page Not Found | Selwyn Jesudas',
